...
WORDLIST_FILENAME = "/Users/ianmeza/Development/edx/edx-6.00.1x/ProblemSet4/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    """
    if word in wordList:
        processedWord = getFrequencyDict(word)
        for letter in word:
            if not hand.get(letter, 0) >= processedWord.get(letter, 0) :
                return False
        return True
    else:
        return False
