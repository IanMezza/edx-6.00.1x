...
def estimateLowestPaymentBisection(balance, annualInterestRate):
    ...
    estimatedBalance = estimateRemainingBalance(balance, annualInterestRate, monthlyPayment)
    while estimatedBalance > 0.0 or estimatedBalance < -0.0:
